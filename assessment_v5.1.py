...
class Converter:
    ...
    def open_endorsements_window(self):
        ...
        # Dropdown menu for endorsements
        endorsement_label = Label(endorsements_window, text="Select Endorsement:")
        endorsement_label.pack()

        endorsement_var = tk.StringVar()
        endorsement_combobox = ttk.Combobox(endorsements_window, width=20, textvariable=endorsement_var)
        endorsement_combobox['values'] = ('Achieved', 'Merit', 'Excellence')
        endorsement_combobox.set('Achieved')  # Set default value
        endorsement_combobox.pack()
